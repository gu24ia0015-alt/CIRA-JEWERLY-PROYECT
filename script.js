...
const productos = [
    ...
    { id: 2, nombre: "Promesa Eterna", precio: 3200, categoria: "anillos", img: "https://images.unsplash.com/photo-1603561591411-07134e71a2a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 3, nombre: "Corazón Real", precio: 5100, categoria: "anillos", img: "https://images.unsplash.com/photo-1598560976505-d41c19b6e8e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    ...
    { id: 8, nombre: "Corazón del Océano", precio: 3100, categoria: "collares", img: "https://images.unsplash.com/photo-1599643477877-53135375f97e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    ...
    { id: 14, nombre: "Eslabón Cubano", precio: 2800, categoria: "pulseras", img: "https://images.unsplash.com/photo-1535632707235-7484dce45e9e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 15, nombre: "Perlas de Río", precio: 3400, categoria: "pulseras", img: "https://images.unsplash.com/photo-1611085583191-a3b181a88401?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" }
];
...
// Función para mostrar una lista específica de productos
function mostrarProductos(listaDeProductos) {
    contenedorJoyas.innerHTML = ""; // Limpiar el contenedor antes de pintar
...
function filtrarProductos(categoria) {
    // 1. Gestionar la clase "active" visualmente
    const botones = document.querySelectorAll('.filtro-btn');
    botones.forEach(btn => btn.classList.remove('active')); /
    // Buscar qué botón se presionó para ponerle active (Truco visual)
    const botonPresionado = Array.from(botones).find(btn => 
        btn.innerText.toLowerCase() === categoria || 
        (categoria === 'todos' && btn.innerText.toLowerCase() === 'todo')
    );
...
function agregarAlCarrito(id) {
    ...
    if (producto) {
        ...
        alert(`¡Añadiste "${producto.nombre}"!\nLlevas ${carrito.length} joyas.`);
    }
}
